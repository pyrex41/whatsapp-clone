...
config :globalbridge_backend, GlobalbridgeBackendWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "0YeViUDq94ayozxf/X+k9sHiAXSBKE1JrLMOgd/hF0OKNrgQmjRwrGQtDxBudFDd",
  watchers: []
...
config :globalbridge_backend, dev_routes: true
...
# Configure SQLite database for shared data
